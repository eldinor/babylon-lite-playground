import type { AssetMap, ParentMessage, PreviewMessage } from "../playground-types";

let runToken = 0;

declare global {
  interface Window {
    playgroundAssets: AssetMap;
  }
}

function post(message: PreviewMessage): void {
...
async function runSource(message: ParentMessage): Promise<void> {
